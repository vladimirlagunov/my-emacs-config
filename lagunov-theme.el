...
(custom-theme-set-faces
 'lagunov
 '(default ((t (:family "Input Mono" :foundry "unknown" :width normal :height 120 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "black" :background "white" :stipple nil :inherit nil))))
 ...
 '(font-lock-string-face ((t (:foreground "SlateBlue4"))))
 '(font-lock-type-face ((t (:foreground "DarkGoldenrod4"))))
