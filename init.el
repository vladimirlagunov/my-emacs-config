...
(eval-file "my_config/elisp.el")
(load-file "my_config/fundamental.el")
;; (load-file "my_config/helm.el")
(load-file "my_config/powerline.el")
(load-file "my_config/usability.el")
(load-file "my_config/python.el")
(load-file "my_config/c.el")
(load-file "my_config/javascript.el")
(load-file "my_config/xml.el")
(load-file "my_config/shell.el")
(load-file "my_config/debian.el")
(load-file "my_config/sql.el")
(load-file "my_config/go.el")
(load-file "my_config/perl.el")
(load-file "my_config/go.el")
;; (load-file "my_config/cedet.el")
